        ...
        <div
          ...
          <div class="flex flex-col items-center">
            ...
            <form @click.prevent="" class="w-full mt-3">
              ...
              <div class="mb-3 flex flex-col">
                <label for="email" class="block mb-2 text-base font-sans text-gray-700">Email address</label>
                <input v-model="form.email" type="email" id="email" class="w-full border border-signupBorder rounded p-2"
              ...
              <div class="mb-3 flex flex-col">
                ...
                <div class="border border-signupBorder rounded">
                  <input v-model="passwords.password" type="password" id="password"
                    class="w-full border-0rounded p-2 outline-none" required />
                </div>
              ...
              <div class="mb-3">
                <label for="confirmPassword" class="block mb-2 text-base font-sans text-gray-700">Confirm Password</label>
                <input type="password" id="confirmPassword" class="w-full border border-signupBorder rounded p-2" required
